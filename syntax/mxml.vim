...
"                                                                                                                                                                                                                                                                                                                                                                                                                   start="<?" end="?>" contains=xmlAttrib,xmlEqual,xmlString
"
"
"                                                                                                                                                                                                                                                                                                                                                                                                                   if
"                                                                                                                                                                                                                                                                                                                                                                                                                   exists('g:mxml_syntax_folding')
...
"        syn region  Script start=+<mx:Script[^>]*>+ keepend
"        end=+</mx:Script>+me=s-1
"        contains=@mxmlScript,mxmlCssStyleComment,mxmlScriptTag,@htmlPreproc
"          syn region  mxmlScriptTag     contained start=+<mx:Script+ end=+>+
"          contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError,htmlEvent
"            MXMLHiLink mxmlScriptTag xmlTag
"
"  syn region mxmlEvent        contained start=+\<on\a\+\s*=[\t ]*'+ end=+'+
"  keepend contains=mxmlEventSQ
"    syn region mxmlEvent        contained start=+\<on\a\+\s*=[\t ]*"+ end=+"+
"    keepend contains=mxmlEventDQ
"      syn region mxmlEventSQ        contained start=+'+ms=s+1 end=+'+me=s-1
"      contains=@mxmlScript
"        syn region mxmlEventDQ        contained start=+"+ms=s+1 end=+"+me=s-1
"        contains=@mxmlScript
"          MXMLHiLink mxmlEventSQ mxmlEvent
"            MXMLHiLink mxmlEventDQ mxmlEvent
"
"              " a javascript expression is used as an arg value
"                syn region  actionScriptExpression contained start=+&{+
"                keepend end=+};+ contains=@mxmlScript,@htmlPreproc
"                endif
